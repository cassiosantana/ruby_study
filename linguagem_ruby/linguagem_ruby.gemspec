...
require_relative "lib/linguagem_ruby/version"

Gem::Specification.new do |spec|
  spec.name = "linguagem_ruby"
  spec.version = LinguagemRuby::VERSION
  spec.authors = ["Cassio Santana"]
  spec.email = ["cassioo.roger@gmail.com"]

  spec.summary = "Estudo Ruby"
  spec.description = "Este repositorio armazena as tarefas e exercícios do curso linguagem ruby"
